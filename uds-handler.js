class UDSHandler {
    constructor(server) {
        ...
        this.callback['close_menu_item'] = this.callback['menu_item'] = this.callback['close_sharp_input'] = this.callback['start_sharp_input'] = this.callback['sharp_input'] = this.callback['inventory'] = this.callback['more'] = this.callback['close_more'] = this.callback['large_text'] = this.callback['close_large_text'] = (data, info) => {
            info.room ? this.wsSender.dataToRoom(data, info.room) : void 0;
        }
    }
